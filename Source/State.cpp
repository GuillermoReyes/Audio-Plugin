/*
  ...
  ==============================================================================
*/
//Portion  taken from Jake Flynn, Original Author
#include "State.h"

void saveStateToXml (const AudioProcessor& proc, XmlElement& xml)
{
    xml.removeAllAttributes(); // clear first
    // Ensure that all parameters are registered to the main Parameter
...
deletePresetButton {"Delete preset"}
{
    ...
    /*
    toggleABButton.setColour (TextButton::textColourOffId, Colours::white);    // possibly set in custom Look instead??? - YES
    toggleABButton.setColour (TextButton::buttonColourId, Colour (0xff808080));     // make this the sauceOrange Colour
